function HCP_FC_truncate(outmat, fMRI_ls, fake_censor_ls, ROI_file)

% HCP_FC_truncate(outmat, fMRI_ls, fake_censor_ls, ROI_file)
%
% 
...
CBIG_ComputeROIs2ROIsCorrelationMatrix(outmat, fMRI_ls, fMRI_ls, ...
    fake_censor_ls, ROI_file, ROI_file, 'NONE', "NONE", 1, 0)
