function HCP_whisker_acc_AAvsWA(bhvr_ls, group_diff, perm_fname, metric, outdir, outstem, ...
    mtch_bhvr_ls, mtch_colloq_ls)

% HCP_whisker_acc_AAvsWA(bhvr_ls, group_diff, perm_fname, metric, outdir, outstem, ...
%     full_bhvr_ls, full_colloq_ls)
%
% Create whisker plot to show the accuracy differences between AA and WA.
%
% Inputs:
% - bhvr_ls
...
HCP_whisker_2grp_indiv(data_sort, colormat, y_label, legends, [], ...
	colloq_nm_sort, IA, outdir, outstem)

%% plot the average
avg_data = mean(data_sort, 3)';
HCP_whisker_2grp_avg(avg_data, colormat, y_label, legends, outdir, outstem)
